...
class VipOrderBillExport extends DefaultValueBinder implements WithStrictNullComparison, Responsable, FromQuery, WithMapping, WithHeadings, ShouldAutoSize, WithCustomValueBinder
{
    use Exportable;
    ...
    public function withRequest(Request $request, VipBill $bill)
    {
    ...
    public function query()
    {
        ...
        $query->where('shop_id', $this->bill->shop_id);
        $query->where('bill_date', $this->bill->date);
