...
{
    $url = "https://restapi.amap.com/v3/distance?origins={$shop->shop_lng},{$shop->shop_lat}&destination={$lng},{$lat}&key=c21d0fa918dbeb5010ba288688cabb96&type=1";
...
{
    $url = "https://restapi.amap.com/v3/direction/walking?origin={$shop->shop_lng},{$shop->shop_lat}&destination={$lng},{$lat}&key=c21d0fa918dbeb5010ba288688cabb96";
...
function getMoney($shop, $receiver_lng, $receiver_lat) {
    ...
    $url = "https://restapi.amap.com/v4/direction/bicycling?origin={$shop->shop_lng},{$shop->shop_lat}&destination={$receiver_lng},{$receiver_lat}&key=c21d0fa918dbeb5010ba288688cabb96";
    // $url = "https://restapi.amap.com/v3/distance?origins={$shop->shop_lng},{$shop->shop_lat}&destination={$model->receiver_lng},{$model->receiver_lat}&key=c21d0fa918dbeb5010ba288688cabb96&type=1";
